    ...
    methods: {
        getInfo() {
            this.$axios.get('/users/userInfo').then(res => {
                ...
                this.access = res.data.data.role
...
1.在表单中选择合适的并添加样式，希望点击新增按钮能够进行弹显示
...
![image-20240607230632364](./images/image-20240607230632364.png)
...
![image-20240626232937486](./images/image-20240626232937486.png)
