...
![image-20240701200023898](./images/image-20240701200023898.png)

页面的数据会丢失而我希望的是展示第二条数据

![image-20240701200112431](./images/image-20240701200112431.png)

## 解决

### 在查询全部数据当中添加判断

如果返回数据为空的话，就是`length=0`，说明第三页没有查出来数据，这个时候就往前进一页，也就是当前第三页减1第三页减一就是第二页，所以减一下之后查的其实是第二页的数据，然后再调一下查询全部数据的接口,刷新数据
...
![image-20240701200218763](./images/image-20240701200218763.png)
